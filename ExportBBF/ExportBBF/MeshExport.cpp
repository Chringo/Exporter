				...
				if (attrName[1] == 'B')
					if (attrName[2] == 'O')
						if (attrName[3] == 'X')
						{
							...
							trans.getRotation(rotation, rotationOrder);
							...
							MVector extensionDirections = { 1,1,1 };
